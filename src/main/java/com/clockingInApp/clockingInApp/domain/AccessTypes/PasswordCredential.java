 ...
 */
@Entity
public class PasswordCredential implements Comparable<PasswordCredential> {
    ...
    @Override
    public int compareTo(PasswordCredential o) {
        return this.userPasswordCredentials.compareToIgnoreCase(o.userPasswordCredentials);
    }
